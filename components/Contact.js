...
export const Contact = () => {
  ...
  return (
    ...
    <h1 className="text-4xl text-green-600 text-center font-bold mb-10">Contáctanos</h1>
    <div className="flex w-2/3 pb-10 pt-5 mx-auto rounded-lg justify-center bg-emerald-500">
